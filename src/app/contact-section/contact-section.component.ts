...
export class ContactSectionComponent {
   ...
   async sendMail() {
      ...
      this.disableInputs(this.nameField, this.emailField, this.messageField, this.sendButton);
      ...
      this.enableInputs(this.nameField, this.emailField, this.messageField, this.sendButton);
